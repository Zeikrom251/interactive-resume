...
export interface ResumeConfig {
  ...
  pdf?: {
    ...
    /** URL to the interactive resume — shown as a contact link only in the PDF output */
    interactiveUrl?: string;
    /** Label for the interactive resume link — localised */
    interactiveLabel?: LocalizedString;
  };
  theme?: {
    preset?: PresetName;
